...
class LLMClient:
    ...
    def json_chat(self, system: str, user: str, json_schema: Optional[Dict]=None) -> Dict[str, Any]:
        """
    ...
    def tool_choice(self, system: str, user: str, tools: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
